...
#	git clone -b 1.1 http://haungjue.deng:SiteView123@git.dnetlab.com/dnet/tinc.git $git_tinc
#	cd $git_tinc
#	git pull
#	autoreconf -fsi
#	chmod 777 configure
...
git clone http://bowen.yan:siteview123%21%40%23@git.dnetlab.com/dnet/dnetnode.git
cd dnetnode
...
cp /root/dnetnode/cert.pem ./dnetovr/root/dnetovr
cp /root/dnetnode/key.pem ./dnetovr/root/dnetovr
cp /root/dnetnode/settings.toml.example ./dnetovr/root/dnetovr/settings.toml
cp /root/dnetnode/target/release/dnetovr ./dnetovr/root/dnetovr

cp /root/dnetnode/compile_script/control  ./dnetovr/DEBIAN
cp /root/dnetnode/compile_script/dnetovr.service  ./dnetovr/lib/systemd/system/dnetovr.service
