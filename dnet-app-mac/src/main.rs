...
fn main() {
    unsafe {
        ...
        // create a second tab view item
        let tab_view_item3 = NSTabViewItem::new(nil)
            .initWithIdentifier_(NSString::alloc(nil).init_str("TabView3"));

        tab_view_item3.setLabel_(NSString::alloc(nil).init_str("Tab view item 3"));
        tab_view.addTabViewItem_(tab_view_item3);
